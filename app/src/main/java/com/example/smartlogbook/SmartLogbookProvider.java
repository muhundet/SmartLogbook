...
public class SmartLogbookProvider extends ContentProvider {
    OpenHelper mDbOpenHelper;
    public SmartLogbookProvider() {
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        cursor = db.query(DatabaseContract.RegisterEntry.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
        return cursor;
    }
